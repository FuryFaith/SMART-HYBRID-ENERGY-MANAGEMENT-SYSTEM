...
//Membership Function Declaration for Fuzzy Input And Output ------------------------------------------------------------------
  ...
  FuzzySet *medium_bat = new FuzzySet(0, 1, 9, 10);
...
void loop() {
 ...
 //Battery2 Voltage
  ...
  Serial.println("Battery Status Testing values --");
  ...
  Serial.println("-- Current Testing ---");
  ...
  Serial.println("Manual Time in Hrs: ");
  int timer = GetNumber();
  Serial.println("");
  int timee = tm.Hour;
  if(timer)
  ...
  Serial.println("Manual Battery_1 Value: ");
  int bat1 = GetNumber();
  Serial.println("");
  Serial.println("");
  if(bat1)
  ...
  Serial.println("");
  Serial.println("Manual Battery_2 Value: ");
  int bat2 = GetNumber();
  Serial.println("");
  Serial.println("");
  if(bat2)
  ...
  average2 = sensor2.getCurrentAC();
  float avg = average2;
  Serial.println("Manual Grid Value: ");
  int grida = GetNumber();
  Serial.println("");
  Serial.println("");
  if(grida == 1)
  ...
  Serial.println("Manual Load_Power Value: ");
  int load_power = GetNumber();
  Serial.println("");
  Serial.println("");
  average1 = sensor1.getCurrentAC();
  delay(1000);
  ...
  int input1 = timee;// To Set any input randomly we can also use the random fuction ( random(x,y); )
